            ...
            {spinner ?
                ...
                <IonContent >
                    ...
                    <IonModal keepContentsMounted={true}>
                        <IonDatetime id="date" presentation='date' value={date} onIonChange={e => setDate(e.detail.value as string)} isDateEnabled={enabledDates} min={moment().format()}></IonDatetime>
                    </IonModal>
                    <IonModal keepContentsMounted={true}>
