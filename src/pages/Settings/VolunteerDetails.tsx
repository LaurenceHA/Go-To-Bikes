...
const VolunteerDetails: React.FC = () => {
    ...
    function fetchData() {
        axios.get(api_url + 'volunteers/' + authValues.user.id + api_key + '&resource_id=' + authValues.user.id + '&resource_type=' + authValues.user.type)
            .then((res: any) => {
    ...
    function update() {
        ...
        axios.patch(api_url + 'volunteers/' + authValues.user.id + '/update' + api_key, data)
            .then((res: any) => {
                setUploading(false);
            ...
            <IonContent >
                ...
                <IonList>
                    <IonItem>
                        ...
                        <IonInput onIonChange={e => setFirstName(e.detail.value as string)} value={firstName} autocapitalize="sentences"></IonInput>
                    </IonItem>
                    <IonItem>
                        <IonLabel position="stacked">Last Name: </IonLabel>
                        <IonInput onIonChange={e => setLastName(e.detail.value as string)} value={lastName} autocapitalize="sentences"></IonInput>
                    </IonItem>
                    <IonItem>
