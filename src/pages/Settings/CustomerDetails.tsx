...
const CustomerDetails: React.FC = () => {
    ...
    function fetchData() {
        axios.get(api_url + 'customers/' + authValues.user.id + api_key + '&resource_id=' + authValues.user.id + '&resource_type=' + authValues.user.type)
            .then((res: any) => {
    ...
    function update() {
        ...
        axios.patch(api_url + 'customers/' + authValues.user.id + '/update' + api_key, data)
            .then((res: any) => {
